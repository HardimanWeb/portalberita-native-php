        ...
        <div class="option_menu">
            ...
            <a href="validasiBerita.php">
                <div class="option">
                    ...
                    <h4 class="active">Validasi Berita</h4>
                </div>
            </a>
        ...
        <div class="tabel">
            <table border="1" id="table_id">
                ...
                <tbody>
                    <?php 
			include 'koneksi.php';
			$sql = "Select * from isi_berita where status=''";
			...
			?>
                    <tr>
                        ...
                        <td class="aksi"><button class="btn btn-danger"><a
                                    href="deleteBerita.php?id=<?php echo $rd['id_berita'] ?>">Tolak</a></button>
                            <button class="btn btn-success" type="submit" name="publish"><a
                                    href="validasi.php?id=<?php echo $rd['id_berita']; ?>">Publish</a></button>
                        </td>
                    </tr>
                    <?php } ?>
                <tbody>
